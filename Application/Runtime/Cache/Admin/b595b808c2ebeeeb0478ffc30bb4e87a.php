            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo U('Admin/Login/logout','',false);?>"><i class="fa fa-sign-out fa-fw"></i>退出登入</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo U('Admin/Login/logout','',false);?>"><i class="fa fa-files-o fa-fw"></i>退出系统</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
